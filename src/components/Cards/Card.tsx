    ...
    return (
        <button
            ...
            <section id="buttons" className="flex gap-3">
                <button onClick={editFunc} className="text-white font-semibold p-0.5 pl-4 pr-4 bg-emerald-500">Edit</button>
                <button onClick={deleteFunc} className="text-white font-semibold p-0.5 pl-4 pr-4 bg-red-500">Delete</button>
            </section>
        </button>
    )
}